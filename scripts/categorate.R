...
#'bases: 
#'LOTUS the natural products occurrence database (https://lotus.naturalproducts.net/), 
...
#'information for every chemical of interest [chemical]. Functional 
#'matches are also generated by matching with groups from a chemical 
#'library [chemical_library].
#'
#'
