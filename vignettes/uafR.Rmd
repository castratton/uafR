...
## <span style="color: rgba(104, 0, 96, 1); font-size:120%; background-color: rgba(0, 0, 0, 0)">Hello [Chemical] World!</span>
...
## <span style="color: rgba(104, 0, 96, 1); font-size:120%; background-color: rgba(0, 0, 0, 0)">New Standard, GC/MS Workflows</span>
...
|        <span style="color: black; font-size:115%; background:inherit">Getting back to the GC/MS workflow, subsetting the `query_chemicals` with these outputs is very easily achieved using basic R code:</span>
