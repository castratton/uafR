...
***
#### When Chemicals are Known {.tabset}
...
```
<font size="3.2"> **`query_chemicals = c("Ethyl hexanoate", "Methyl salicylate", "Octanal", "Undecane")`** </font>
```{r, echo = F}
# print(query_chemicals)
```

<span style="color: black; font-size:115%; background:inherit">`mzExacto()` takes the **output from spreadOut()** and this list of **query chemicals**: </span> 
...
```
<font size="3.2"> **`mzExacto(standard_spread, query_chemicals)`** </font>  
...
:-----------------|:-------:|:------------:|:------:|:-------------:|:-------:
ethyl hexanoate   |RNH2     |0             |C       |8              |0
ethyl hexanoate   |R3N      |0             |O       |2              |0
ethyl hexanoate   |ROH      |0             |H       |16             |0
methyl salicylate |RNH2     |0             |C       |8              |0
methyl salicylate |R3N      |0             |O       |3              |0
methyl salicylate |ROH      |1             |H       |8              |0
octanal           |RNH2     |0             |C       |8              |0
octanal           |R3N      |0             |O       |1              |0
octanal           |ROH      |0             |H       |16             |0
undecane          |RNH2     |0             |C       |11             |0
undecane          |R3N      |0             |C       |11             |0
undecane          |ROH      |0             |C       |11             |0
...
<font size="3.2"> `query_chems = standard_dat$Compound.Name[standard_dat$Match.Factor >= 65]`</font>
...
|        <span style="color: black; font-size:115%; background:inherit">But, the combined `Match.Factor` and `categorate()` approach can and should be the new standard for experiments that yield a large amount of complex chemical data.</span>
